...
- **Discovery Engine**: Multi-layer mechanism with 9 active methods for identifying AI agents, including Coinbase Bazaar indexing. (Feb 2026: `extensions.bazaar` now injected into all 402 responses via x402ResponseEnricher for proper facilitator indexing)
