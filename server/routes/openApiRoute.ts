...
router.get('/openapi.json', (req: Request, res: Response) => {
  ...
  const spec = {
    ...
    info: {
      ...
      version: '3.0.0',
      description: 'Production-grade x402 micropayment infrastructure for AI agents. 65 services across 8 blockchains (7 EVM + Solana), settling in USDC. Categories: Crypto Intelligence, Trading, Market Intelligence, Prediction Markets (Kalshi/Polymarket), Satellite Intelligence (NASA/ESA), IoT & DePIN (fleet telematics, weather stations, sensor data), AI Inference (GPT-4o-mini at $0.05/call), Real Estate, Banking, and Compliance. Pricing: $0.05–$0.25 per call. Free $5 trial key at /api/m2m/credits/trial. Supports API-key prepaid credits and native x402 on-chain USDC payments.',
