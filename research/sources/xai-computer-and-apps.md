...
Title: Use the computer and apps | SpaceXAI Docs
Fetched: 2026-08-29T02:40:33.670Z

#### [Work with Grok Bot](https://docs.x.ai/grok-bot/computer-and-apps\#work-with-grok-bot)

# [Use the computer and apps](https://docs.x.ai/grok-bot/computer-and-apps\#use-the-computer-and-apps)

Copy for LLM [View as Markdown](https://docs.x.ai/grok-bot/computer-and-apps.md)

[Create API key](https://console.x.ai/team/default/api-keys?utm_source=docs&utm_medium=referral&utm_campaign=grok-bot-computer-and-apps&utm_content=article-api-key) [Meet grok-4.6](https://x.ai/news/grok-4-6)
...
## [One computer, shared by all your Bots](https://docs.x.ai/grok-bot/computer-and-apps\#one-computer-shared-by-all-your-bots)
...
## [Watch computer work](https://docs.x.ai/grok-bot/computer-and-apps\#watch-computer-work)
...
## [Take over for a sensitive step](https://docs.x.ai/grok-bot/computer-and-apps\#take-over-for-a-sensitive-step)
...
## [Sign in once](https://docs.x.ai/grok-bot/computer-and-apps\#sign-in-once)
...
## [Connect an app](https://docs.x.ai/grok-bot/computer-and-apps\#connect-an-app)
...
## [Work with files](https://docs.x.ai/grok-bot/computer-and-apps\#work-with-files)
...
## [Update, recover, or reset the computer](https://docs.x.ai/grok-bot/computer-and-apps\#update-recover-or-reset-the-computer)
...
[Troubleshooting](https://docs.x.ai/grok-bot/troubleshooting) for the least-destructive order.

## [Your local computer is separate](https://docs.x.ai/grok-bot/computer-and-apps\#your-local-computer-is-separate)
