...
function generate402Response(
  ...
  const descriptions: Record<string, string> = {
    ...
    "multi-chain-balance": "USDC/ETH/top-token balances across 7 EVM chains + Solana in one call. USD-denominated totals. Pass { address } — no chain parameter needed.",
    ...
    "payment-processing": "Route USDC/stablecoin payments across 7 EVM chains + Solana. Returns optimal network for lowest fees, estimated confirmation time, and payment receipt with txHash.",
