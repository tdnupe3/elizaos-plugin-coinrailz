        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6 text-sm text-gray-700">
              ...
              <div className="flex items-center space-x-2">
                <Badge className="bg-blue-100 text-blue-800">✓ 69 Pay-Per-Call APIs</Badge>
              </div>
              <div className="flex items-center space-x-2">
            ...
            <div className="max-w-2xl mx-auto mb-5 px-4">
              <div className="bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 flex items-start space-x-3">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                  <span className="font-semibold text-slate-800">x402 Protocol — Open Internet Standard</span> governed by the Linux Foundation. Members include AWS, Google, Microsoft, Mastercard, Cloudflare, Stripe, Adyen, Circle, and Shopify. Coin Railz operates 69 discoverable x402 services for autonomous AI agent data purchasing.
                </p>
              </div>
            </div>
                ...
                <div className="text-center">
                  ...
                  <div className="space-y-2 text-left max-w-xl mx-auto mb-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <span className="text-sm text-gray-700">69 pay-per-call services: DeFi analytics, satellite data, IoT, AI inference</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <Check className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
                ...
                >
                  <div className="flex items-center space-x-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-green-700">Pay by card • Instant API key • All 69 APIs unlocked</div>
                    </div>
                  </div>
                  <Button 
            ...
            <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto mb-6 sm:mb-8">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-blue-600">69</div>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                  <a href="/mcp/services" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-2 bg-white border border-gray-300 rounded px-3 py-2 hover:bg-gray-100 transition-colors">
                    ...
                    <Badge className="bg-blue-100 text-blue-700 text-xs">69 services</Badge>
                  </a>
