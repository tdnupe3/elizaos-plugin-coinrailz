...
export default function X402DocsPage() {
  ...
  useEffect(() => {
    ...
    const schema = {
      ...
      "description": "Production-ready x402 micropayment services for AI agents. 72 microservices including crypto analytics, trading signals, satellite/earth data, IoT sensor feeds, AI inference, prediction markets, balance checking, gas prices, token data, smart contract audits, and security analysis. Instant USDC payments on Base and Solana.",
