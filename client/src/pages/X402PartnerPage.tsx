...
export default function X402PartnerPage() {
  useSEO({
    ...
    description: "Join the x402 ecosystem. 58 services, 14 categories, 6 NASA/ESA satellite data products. Cross-promote, integrate, and grow together.",
    ...
    ogDescription: "58 x402 services across 14 categories. Let's cross-promote and grow the agent economy together.",
  });

  const stats = [
    { label: "x402 Services", value: "58", sub: "across 14 categories" },
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Coin Railz runs 58 x402 micropayment services on Base. We found your services on Bazaar and think there's an opportunity to collaborate.
            </p>
          </div>
