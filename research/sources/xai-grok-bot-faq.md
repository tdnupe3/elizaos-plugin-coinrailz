Source: https://docs.x.ai/grok-bot/faq
Title: Frequently asked questions | SpaceXAI Docs
Fetched: 2026-08-29T02:40:40.215Z

#### [Help](https://docs.x.ai/grok-bot/faq\#help)

# [Frequently asked questions](https://docs.x.ai/grok-bot/faq\#frequently-asked-questions)

Copy for LLM [View as Markdown](https://docs.x.ai/grok-bot/faq.md)

[Create API key](https://console.x.ai/team/default/api-keys?utm_source=docs&utm_medium=referral&utm_campaign=grok-bot-faq&utm_content=article-api-key) [Meet grok-4.6](https://x.ai/news/grok-4-6)

## [How is Grok Bot different from an AI assistant?](https://docs.x.ai/grok-bot/faq\#how-is-grok-bot-different-from-an-ai-assistant)
...
## [Where do I talk to Grok Bot?](https://docs.x.ai/grok-bot/faq\#where-do-i-talk-to-grok-bot)
...
## [Does Grok Bot keep working when my laptop is closed?](https://docs.x.ai/grok-bot/faq\#does-grok-bot-keep-working-when-my-laptop-is-closed)

Yes. Bot work runs on the cloud computer. Closing the app, laptop, or iPhone
does not stop a background turn or routine.

## [Do my Bots share one computer?](https://docs.x.ai/grok-bot/faq\#do-my-bots-share-one-computer)
...
## [Can several Bots work at the same time?](https://docs.x.ai/grok-bot/faq\#can-several-bots-work-at-the-same-time)
...
## [What does a Bot remember?](https://docs.x.ai/grok-bot/faq\#what-does-a-bot-remember)
...
## [Can Grok Bot use any website?](https://docs.x.ai/grok-bot/faq\#can-grok-bot-use-any-website)
...
## [What actions require my approval?](https://docs.x.ai/grok-bot/faq\#what-actions-require-my-approval)
...
## [How does Grok Bot handle data and privacy?](https://docs.x.ai/grok-bot/faq\#how-does-grok-bot-handle-data-and-privacy)
...
[Approvals, security, and privacy](https://docs.x.ai/grok-bot/approvals-security-and-privacy) for the
full boundary and links to current Cursor security information.

## [How much does Grok Bot cost?](https://docs.x.ai/grok-bot/faq\#how-much-does-grok-bot-cost)
...
## [Is Grok Bot available to teams and enterprises?](https://docs.x.ai/grok-bot/faq\#is-grok-bot-available-to-teams-and-enterprises)
...
## [Which platforms are supported?](https://docs.x.ai/grok-bot/faq\#which-platforms-are-supported)
...
## [What is the difference between a skill and a routine?](https://docs.x.ai/grok-bot/faq\#what-is-the-difference-between-a-skill-and-a-routine)
...
## [Can I show a Bot how I do a task?](https://docs.x.ai/grok-bot/faq\#can-i-show-a-bot-how-i-do-a-task)
...
## [Can I share a Bot with someone else?](https://docs.x.ai/grok-bot/faq\#can-i-share-a-bot-with-someone-else)
...
[Share a Bot](https://docs.x.ai/grok-bot/bots#share-a-bot).

## [What happens if I delete a Bot?](https://docs.x.ai/grok-bot/faq\#what-happens-if-i-delete-a-bot)
