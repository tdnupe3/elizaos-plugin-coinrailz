...
Title: Grok Bot | SpaceXAI Docs
Fetched: 2026-08-29T02:40:30.782Z

#### [Grok Bot](https://docs.x.ai/grok-bot/overview\#grok-bot)

# [Grok Bot](https://docs.x.ai/grok-bot/overview\#grok-bot-1)

Copy for LLM [View as Markdown](https://docs.x.ai/grok-bot/overview.md)

[Create API key](https://console.x.ai/team/default/api-keys?utm_source=docs&utm_medium=referral&utm_campaign=grok-bot-overview&utm_content=article-api-key) [Meet grok-4.6](https://x.ai/news/grok-4-6)
...
## [What makes Grok Bot different](https://docs.x.ai/grok-bot/overview\#what-makes-grok-bot-different)
...
## [Bots share one computer](https://docs.x.ai/grok-bot/overview\#bots-share-one-computer)
...
## [A good first handoff](https://docs.x.ai/grok-bot/overview\#a-good-first-handoff)
...
## [What to explore next](https://docs.x.ai/grok-bot/overview\#what-to-explore-next)

- [Get started](https://docs.x.ai/grok-bot/get-started) with the desktop app and your first Bot.
- Discover more [use cases](https://docs.x.ai/grok-bot/use-cases) for Bots.
- Make recurring work repeatable with [skills and routines](https://docs.x.ai/grok-bot/skills-routines-and-automations).
