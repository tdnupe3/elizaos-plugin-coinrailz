// Simple SVG icons to replace lucide-react and eliminate build bottleneck
...
export const Bitcoin = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    <path d="M11.767 19.089c4.924.868 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 18.047m5.908 1.042-.347 1.97m1.563-8.864c4.924.869 6.14-6.025 1.216-6.894m-1.216 6.894L5.86 12.047m5.908 1.042-.347 1.97M15.5 7.5 14 5.5m-9.5 4h2m2-6.5v2"/>
  </svg>
);
...
export const Bot = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    ...
    <path d="m9 16 .5-1 .5 1"/>
    <path d="m15 16-1-2 1 2"/>
    <path d="M9 12h.01"/>
    <path d="M15 12h.01"/>
  </svg>
);
...
// Additional icons based on usage
...
export const MemoryStick = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    ...
    <path d="M14 19v-3"/>
    <path d="M18 19v-3"/>
    <path d="M5 16h14a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1H5a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1Z"/>
    <path d="M8 7V5h8v2"/>
  </svg>
);
...
export const Sparkles = ({ className = "", size = 24 }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
    <path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l0 0A2 2 0 0 0 7.063 15.5l0 0A2 2 0 0 0 8.5 16.937l0 0A2 2 0 0 0 9.937 15.5l0 0Z"/>
    <path d="M14.8 9.1a2.2 2.2 0 0 0-1.6-1.6l0 0a2.2 2.2 0 0 0-1.6 1.6l0 0a2.2 2.2 0 0 0 1.6 1.6l0 0a2.2 2.2 0 0 0 1.6-1.6l0 0Z"/>
    <path d="M18.5 21a2.5 2.5 0 0 0-1.8-1.8 2.5 2.5 0 0 0-1.8 1.8 2.5 2.5 0 0 0 1.8 1.8 2.5 2.5 0 0 0 1.8-1.8"/>
  </svg>
);
