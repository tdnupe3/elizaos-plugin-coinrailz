...
const SERVICES: ServiceConfig[] = [
  ...
  { name: "token-metadata", priceUsd: 0.10, weight: 11, method: "POST", body: { tokenAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: "base" }, userAgentCategory: "defi-bot" },
  { name: "token-price", priceUsd: 0.25, weight: 10, method: "POST", body: { tokenAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: "base" }, userAgentCategory: "trading-bot" },
  { name: "trade-signals", priceUsd: 0.75, weight: 8, method: "POST", body: { token: "ETH", timeframe: "1h", riskLevel: "medium" }, userAgentCategory: "trading-bot" },
  { name: "wallet-risk", priceUsd: 0.50, weight: 7, method: "POST", body: { walletAddress: "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", chain: "ethereum" }, userAgentCategory: "research-agent" },
  ...
  { name: "multi-chain-balance", priceUsd: 0.50, weight: 5, method: "POST", body: { walletAddress: "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", chains: ["base", "ethereum", "polygon"] }, userAgentCategory: "infrastructure" },
  { name: "dex-liquidity", priceUsd: 0.20, weight: 6, method: "POST", body: { tokenAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: "base" }, userAgentCategory: "defi-bot" },
  { name: "token-sentiment", priceUsd: 0.25, weight: 6, method: "POST", body: { tokenSymbol: "ETH", chain: "ethereum" }, userAgentCategory: "research-agent" },
  { name: "whale-alerts", priceUsd: 0.35, weight: 5, method: "POST", body: { tokenAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: "base", threshold: 100000 }, userAgentCategory: "trading-bot" },
  { name: "batch-quote", priceUsd: 0.40, weight: 4, method: "POST", body: { fromToken: "0x4200000000000000000000000000000000000006", toToken: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", amount: "1000000000000000000", chain: "base" }, userAgentCategory: "defi-bot" },
  { name: "portfolio-tracker", priceUsd: 0.50, weight: 4, method: "POST", body: { walletAddress: "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045", chains: ["ethereum", "base", "polygon"] }, userAgentCategory: "research-agent" },
  { name: "contract-scan", priceUsd: 1.00, weight: 3, method: "POST", body: { contractAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", chain: "base" }, userAgentCategory: "infrastructure" },
  ...
  { name: "approval-manager", priceUsd: 0.20, weight: 4, method: "POST", body: { tokenAddress: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", spender: "0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD", amount: "unlimited", chain: "base" }, userAgentCategory: "defi-bot" },
  ...
  { name: "polymarket-events", priceUsd: 0.25, weight: 5, method: "POST", body: { limit: 5, active: true, sortBy: "volume" }, userAgentCategory: "trading-bot" },
  ...
  { name: "credit-risk-score", priceUsd: 1.25, weight: 2, method: "POST", body: { applicantInfo: { annualIncome: 120000, employmentYears: 5 }, requestedAmount: 25000 }, userAgentCategory: "infrastructure" },
  { name: "compliance-check", priceUsd: 1.75, weight: 1, method: "POST", body: { entityType: "individual", jurisdiction: "US", transactionType: "crypto-purchase", amount: 10000 }, userAgentCategory: "infrastructure" },
  { name: "correlation-matrix", priceUsd: 0.75, weight: 3, method: "POST", body: { assets: ["ETH", "BTC", "SOL"], timeframe: "30d" }, userAgentCategory: "research-agent" },
  { name: "risk-metrics", priceUsd: 1.00, weight: 2, method: "POST", body: { portfolioValue: 100000, holdings: [{ asset: "ETH", value: 50000 }, { asset: "BTC", value: 30000 }, { asset: "USDC", value: 20000 }] }, userAgentCategory: "research-agent" },
  { name: "arbitrage-scanner", priceUsd: 1.25, weight: 2, method: "POST", body: { assets: ["ETH", "USDC"], chains: ["base", "polygon", "arbitrum"], minProfitPercent: 0.5 }, userAgentCategory: "trading-bot" },
  { name: "property-valuation", priceUsd: 0.75, weight: 2, method: "POST", body: { address: "123 Main St, San Francisco, CA", propertyType: "residential" }, userAgentCategory: "research-agent" },
  { name: "lease-analysis", priceUsd: 1.00, weight: 1, method: "POST", body: { propertyAddress: "350 5th Ave, New York, NY", leaseType: "commercial", monthlyRent: 5000 }, userAgentCategory: "research-agent" },
  { name: "construction-progress", priceUsd: 1.50, weight: 1, method: "POST", body: { projectDescription: "Mixed-use residential tower in downtown Austin TX with 200 units", projectType: "residential", currentPhase: "foundation" }, userAgentCategory: "data-agent" },
  { name: "trading-signal", priceUsd: 1.00, weight: 3, method: "POST", body: { symbol: "ETH", timeframe: "4h", riskTolerance: "moderate" }, userAgentCategory: "trading-bot" },
  { name: "portfolio-optimization", priceUsd: 2.00, weight: 1, method: "POST", body: { currentHoldings: [{ asset: "ETH", amount: 10, currentValue: 30000 }, { asset: "BTC", amount: 0.5, currentValue: 25000 }], riskTolerance: "moderate" }, userAgentCategory: "research-agent" },
  ...
  { name: "instant-agent-wallet", priceUsd: 1.00, weight: 2, method: "POST", body: { description: "Test agent wallet" }, userAgentCategory: "infrastructure" },
  { name: "instant-api-key", priceUsd: 1.00, weight: 2, method: "POST", body: { agentId: "test-agent-001" }, userAgentCategory: "infrastructure" },
  { name: "agent-create-wallet", priceUsd: 2.00, weight: 1, method: "POST", body: { agentId: "test-agent-wallet", chain: "base" }, userAgentCategory: "infrastructure" },
  { name: "seamless-chain-bridge", priceUsd: 2.00, weight: 1, method: "POST", body: { fromChain: "ethereum", toChain: "base", amount: "10", toAddress: "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045" }, userAgentCategory: "infrastructure" },
