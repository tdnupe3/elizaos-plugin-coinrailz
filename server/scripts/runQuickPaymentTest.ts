...
async function runTest() {
  ...
  // Create wrapped fetch with x402 payment
  // Max value set to $10 USDC (10 * 10^6 base units)
  const x402Fetch = wrapFetchWithPayment(fetch, walletClient, BigInt(10 * 1_000_000));
