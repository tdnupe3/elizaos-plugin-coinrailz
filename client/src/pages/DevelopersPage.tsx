  ...
  return "✅ Low to medium risk wallet.";
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Swap <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">wallet-risk</code> for any service in the canonical catalog:
                        </p>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-500 rounded-lg p-4">
                    ...
                    <p className="text-sm text-green-800 dark:text-green-200">
                      Your AI agent now has on-chain intelligence, paid per call via x402. The same pattern works across the canonical service catalog.
                    </p>
                  </div>
                </CardContent>
              </Card>
