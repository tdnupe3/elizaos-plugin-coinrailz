...
router.get('/.well-known/x402.json', async (req: Request, res: Response) => {
  ...
  const x402Manifest = {
    ...
    endpoints: [
      {
        path: "/x402/satellite-earthdata",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "NASA Earthdata gateway: precipitation, granule search, SST, soil moisture, ocean color. Pass product= field to select. CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
      {
        path: "/x402/earthdata-granules",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "CMR Granule Search for 1B+ granules (Landsat/Sentinel/MODIS/VIIRS). CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
      {
        path: "/x402/earthdata-precipitation",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "GPM IMERG Precipitation (OPeNDAP point query, 0.1° resolution). CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
      {
        path: "/x402/earthdata-sst",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "MUR Sea Surface Temperature (OPeNDAP 1km, daily). CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
      {
        path: "/x402/earthdata-soil-moisture",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "SMAP Soil Moisture (SPL3SMP granule discovery). CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
      {
        path: "/x402/earthdata-ocean-color",
        methods: ["POST"],
        price_usd: 0.25,
        auth: "x402",
        description: "MODIS Ocean Color/Chlorophyll-a (MODISA_L3m_CHL). CDP/Bazaar compatible.",
        status: "healthy",
        category: "satellite-intelligence"
      },
