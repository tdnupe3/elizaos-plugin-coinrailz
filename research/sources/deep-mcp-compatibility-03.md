...
Fetched: 2026-08-29T17:32:22.208Z
...
[Model Context Protocol (MCP)](https://modelcontextprotocol.io/introduction) enables Cursor to connect to external tools and data sources. Install and manage MCP servers from the [Customize](https://cursor.com/docs/customize-cursor) page or configure them in `mcp.json`.
...
Team admins can also distribute MCP servers through a [team marketplace](https://cursor.com/docs/plugins#team-marketplaces). Team-distributed servers appear in Customize alongside personal and workspace MCP servers.
...
`vscode.cursor.mcp.registerServer()`](https://cursor.com/docs/extension-api)
...
## [Enterprise admin controls](https://cursor.com/docs/mcp\#enterprise-admin-controls)
...
### [Team MCP distribution](https://cursor.com/docs/mcp\#team-mcp-distribution)
...
Linking an MCP server to a marketplace does not install or enable it for everyone. Configure **Marketplace Access** and plugin installation modes under **Dashboard > Plugins**. See [Migrate existing Team MCPs](https://cursor.com/docs/plugins#migrate-existing-team-mcps) for the full flow.

### [MCP Allowlist](https://cursor.com/docs/mcp\#mcp-allowlist)
...
### [Network controls](https://cursor.com/docs/mcp\#network-controls)
...
### [User MCP extensions](https://cursor.com/docs/mcp\#user-mcp-extensions)
...
Cursor automatically uses MCP tools listed under `Available Tools` when relevant. This includes [Plan Mode](https://cursor.com/docs/agent/plan-mode). Ask for a specific tool by name or describe what you need. Enable or disable MCP servers from **Customize** in the sidebar.
...
![Tool confirmation prompt](https://cursor.com/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fcontext%2Fmcp%2Ftool-confirm.png&w=1920&q=75&dpl=dpl_9MPkaaTTfAezZQMvqsHxEJK88mo8)

#### [Run Mode](https://cursor.com/docs/mcp\#run-mode)

MCP [follows the same Run Modes as terminal commands](https://cursor.com/docs/agent/security/run-modes#run-mode). For example, in **Auto-review** mode, allowlisted MCP tools run immediately and everything else is routed through the classifier.
...
![MCP tool call result](https://cursor.com/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fcontext%2Fmcp%2Ftool-call.png&w=1920&q=75&dpl=dpl_9MPkaaTTfAezZQMvqsHxEJK88mo8)
...
## [Related](https://cursor.com/docs/mcp\#related)
