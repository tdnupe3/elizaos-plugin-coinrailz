...
Title: Skills, Plugins & Marketplaces | SpaceXAI Docs
Fetched: 2026-08-29T17:32:12.564Z

#### [Features](https://docs.x.ai/build/features/skills-plugins-marketplaces\#features)

# [Skills, Plugins & Marketplaces](https://docs.x.ai/build/features/skills-plugins-marketplaces\#skills-plugins--marketplaces)

Copy for LLM [View as Markdown](https://docs.x.ai/build/features/skills-plugins-marketplaces.md)

[Create API key](https://console.x.ai/team/default/api-keys?utm_source=docs&utm_medium=referral&utm_campaign=build-features-skills-plugins-marketplaces&utm_content=article-api-key) [Meet grok-4.6](https://x.ai/news/grok-4-6)

## [Skills](https://docs.x.ai/build/features/skills-plugins-marketplaces\#skills)
...
## [Plugins](https://docs.x.ai/build/features/skills-plugins-marketplaces\#plugins)
...
## [Hooks](https://docs.x.ai/build/features/skills-plugins-marketplaces\#hooks)
...
Plugin hooks additionally receive `GROK_PLUGIN_ROOT` and `GROK_PLUGIN_DATA` in their environment. For events, the JSON format, and the script contract, see [Hooks](https://docs.x.ai/build/features/hooks).

## [Marketplaces](https://docs.x.ai/build/features/skills-plugins-marketplaces\#marketplaces)
...
## [Subagents](https://docs.x.ai/build/features/skills-plugins-marketplaces\#subagents)
...
## [Claude Code compatibility](https://docs.x.ai/build/features/skills-plugins-marketplaces\#claude-code-compatibility)
...
## [Agents.md compatibility](https://docs.x.ai/build/features/skills-plugins-marketplaces\#agentsmd-compatibility)

Grok also reads the `AGENTS.md` instruction-file family (`AGENTS.md`, `Agents.md`, `AGENT.md`) walked from cwd to the repo root — see [AGENTS.md](https://docs.x.ai/build/features/project-rules) — and discovers user-level skills and commands from:
