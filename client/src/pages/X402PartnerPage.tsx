...
export default function X402PartnerPage() {
  ...
  const stats = [
    { label: "Pay-Per-Call APIs", value: "78", sub: "across 14 categories" },
    { label: "Satellite APIs", value: "6", sub: "NASA + ESA data" },
    { label: "Agents Discovered", value: "3,200+", sub: "via Bazaar indexing" },
    { label: "x402 Challenges", value: "182K+", sub: "402 responses served" },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto">
              Coin Railz runs 78 pay-per-call APIs on Base and Ethereum. We found your services on Bazaar and think there's an opportunity to collaborate.
            </p>
          </div>
